...
lemma lambda_nonzero
  ...
  have l_iota_nonzero := restriction_zero_implies_complement_nonzero l l_ne_zero (λ _ => h_l_unit_zero)
  ...
  have l'_eq_l : l' a = l (Sum.inl a) := Finsupp.comapDomain_apply f l (Function.Injective.injOn hf) a
